db.getCollection('ChannelShippingMethodRules').find().forEach( 
    function(myDoc)
    {
       ...
       if(myDoc.channelShippingMethodList[0].channel == "SA"){
            if(myDoc.channelShippingMethodList[0].shippingMethodSupport.length==2){//sa-collection-delivery...
            ...
            }else if(myDoc.channelShippingMethodList[0].shippingMethodSupport[0] == "collection"){//call sa-collection...
                print("collection");
                db.ChannelShippingMethodRules.update( { _id: myDoc._id },
                    {$set: {"channelShippingMethodList.0":
                    {"channel": "SA","orderValueRules": [  {"currency": "ZAR","minOrderValue": 150,"maxOrderValue": 5000  }],"shippingMethodSupport": ["collection"],"shippingMethodRules": [{"shippingMethod": "collection","customerGroupId": [  NumberInt(3),  NumberInt(5),  NumberInt(6),  NumberInt(7)]  }  ],"shippingChargesRules": [  {"shippingMethod": "collection","charges": [  {"currency": "ZAR","type": "FIXED","collectionCharges": 0,"_class": "za.co.hellogroup.locationService.model.CollectionShippingCharges"  }]  },  {"shippingMethod": "delivery","charges": [  {"minOrderValueForFreeDelivery": 1500,"minOrderValueForDelivery": 500,"currency": "ZAR","type": "FIXED","deliveryCharges": 0,"areaLevelCharges": [  {"areaName": "Area1","chargeType": "FIXED","chargeValue": 0  },  {"areaName": "Area2","chargeType": "FIXED","chargeValue": 0  },  {"areaName": "Area3","chargeType": "FIXED","chargeValue": 0  }],"_class": "za.co.hellogroup.locationService.model.DeliveryShippingCharges"  }]  }]}
                }});
            }
       }
       if(myDoc.channelShippingMethodList[1] != undefined && myDoc.channelShippingMethodList[1].channel == "GLOBAL"){
                   if(myDoc.channelShippingMethodList[1].shippingMethodSupport.length==2){//sa-collection-delivery...
                       print("collection & delivery");
                       db.ChannelShippingMethodRules.update( { _id: myDoc._id },
                   ...
                   }else if(myDoc.channelShippingMethodList[1].shippingMethodSupport[0] == "collection"){//call sa-collection...
                       print("collection");
                       db.ChannelShippingMethodRules.update( { _id: myDoc._id },
                           {$set: {"channelShippingMethodList.1":
                           {"channel": "GLOBAL","orderValueRules": [  {"currency": "USD","minOrderValue": 10,"maxOrderValue": 900  },  {"currency": "GBP","minOrderValue": 8,"maxOrderValue": 750  }],"shippingMethodSupport": [  "collection"],"shippingMethodRules": [  {"shippingMethod": "collection","customerGroupId": [  NumberInt(3),  NumberInt(5),  NumberInt(6),  NumberInt(7)]  }],"shippingChargesRules": [  {"shippingMethod": "collection","charges": [  {"currency": "USD","type": "FIXED","collectionCharges": 0,"_class": "za.co.hellogroup.locationService.model.CollectionShippingCharges"  },  {"currency": "GBP","type": "FIXED","collectionCharges": 0,"_class": "za.co.hellogroup.locationService.model.CollectionShippingCharges"  }]  }]}
                       }});
                   }
              }
}
